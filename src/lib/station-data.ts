...
export const allStations: ChecklistData[] = [
  {
    ...
    actorInstructions: {
      ...
      content: "<h4>DADOS PESSOAIS</h4><p>Nome: Carlos Silva<br />Idade: 25 anos<br />Profissão: Estudante</p><br /><h4>MOTIVO DA CONSULTA</h4><p>Queimadura na perna direita por água viva há cerca de 15 minutos.</p><br /><h4>HISTÓRIA DA DOENÇA ATUAL (HDA)</h4><p>O paciente relata dor intensa na perna direita. Se questionado sobre os detalhes da dor (utilizando um mnemônico como ALICIA-D ou similar), forneça as seguintes informações:</p><ul><li><strong>Início e Causa:</strong> \"Eu estava nadando na praia, há uns 15 minutos, e de repente senti uma fisgada muito forte na perna direita. Acho que encostei em uma água viva.\"</li><li><strong>Localização:</strong> \"A dor é bem aqui na frente da minha coxa direita, onde encostou. Mostra uma área específica na coxa.\"</li><li><strong>Irradiação:</strong> \"Não, parece que a dor fica só nesse lugar mesmo, não está se espalhando.\"</li><li><strong>Qualidade/Tipo da Dor:</strong> \"É uma dor que queima muito, parece uma queimadura mesmo. Na hora senti uma fisgada bem forte também.\"</li><li><strong>Intensidade da Dor:</strong> \"Está doendo bastante, doutor(a). Numa escala de 0 a 10, eu diria que é um 8. É uma dor bem forte e chata.\"</li><li><strong>Duração e Evolução:</strong> \"Começou assim que encostei na água viva, há uns 15 minutos, e desde então está doendo direto, não parou e nem diminuiu.\"</li><li><strong>Fatores de Melhora ou Piora:</strong> \"Eu só saí da água e vim pra cá. Não fiz nada pra tentar aliviar ainda. Não sei se algo piora, mas só de relar a mão já dói mais.\" (Se o estudante sugerir lavar com água doce, diga que alguém na praia falou para não fazer isso).</li><li><strong>Sintomas Associados (Locais):</strong> \"O lugar ficou vermelho na hora e parece que está um pouco inchado. Tem umas marcas compridas, como se fossem uns arranhões vermelhos.\"</li><li><strong>Sintomas Associados (Sistêmicos):</strong> \"Não, fora a dor e o susto, estou me sentindo bem. Sem febre, sem enjoo, não estou com falta de ar nem nada disso.\" (Isso pode ser reforçado/detalhado no Interrogatório Sistemático).</li></ul><br /><h4>INTERROGATÓRIO SISTEMÁTICO</h4><p>Nega febre, calafrios, tontura, falta de ar, náuseas, vômitos, palpitações, dor no peito, ou outros sintomas sistêmicos. Apenas a dor local intensa e o vermelhão/inchaço na perna.</p><br /><h4>ANTECEDENTES</h4><p>Nega alergias medicamentosas ou alimentares conhecidas. Nega doenças crônicas (diabetes, hipertensão, asma, etc.). Vacinação em dia. Nega cirurgias prévias ou internações.</p><br /><h4>HÁBITOS DE VIDA</h4><p>Pratica natação 3 vezes por semana. Dieta balanceada, sem restrições. Nega tabagismo. Consumo social de álcool (cerveja nos finais de semana, sem exageros). Nega uso de drogas ilícitas.</p><br /><h4>COMPORTAMENTO ESPERADO</h4><p>Demonstrar dor e desconforto de forma clara (gemer baixinho, fazer caretas ao falar da dor ou se a área for tocada). Estar ansioso por alívio e um pouco assustado com a intensidade da dor e a aparência da lesão. Seguir as instruções do médico, mas pode perguntar sobre o que está sendo feito se não entender.</p>",
    },
    printedMaterials: [
      {
        id: "pm1-agua-viva",
