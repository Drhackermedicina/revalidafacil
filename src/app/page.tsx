...
// Componente do Modal de Mensagem
const MessageModal = ({ message, onClose }: { message: string | null, onClose: () => void }) => {
...
// Componente da Página de Vídeo Demonstrativo
const VideoDemoPage = ({ onNavigateBack }: { onNavigateBack: () => void }) => (
...
// Componente da Página Inicial (Home Page)
const HomePage = ({ onShowVideoDemo, onShowMessage }: { onShowVideoDemo: () => void, onShowMessage: (msg: string) => void }) => (
    ...
    <section className="py-16 px-6 md:px-12 bg-white rounded-lg mx-4 mt-8 shadow-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        <div className="bg-green-50 p-6 rounded-xl shadow-md flex items-center space-x-4">
          <img src="https://placehold.co/80x80/d1fae5/065f46?text=JS" alt="Foto de Perfil de João" className="w-20 h-20 rounded-full object-cover border-4 border-green-200" data-ai-hint="profile person" />
          <div>
        ...
        <div className="bg-green-50 p-6 rounded-xl shadow-md flex items-center space-x-4">
          <img src="https://placehold.co/80x80/d1fae5/065f46?text=MS" alt="Foto de Perfil de Maria" className="w-20 h-20 rounded-full object-cover border-4 border-green-200" data-ai-hint="profile person" />
          <div>
...
// Componente Principal da Aplicação (Landing Page)
export default function App() {
  ...
  // Se a autenticação ainda estiver carregando, ou se o usuário estiver logado (e o redirecionamento para /dashboard estiver prestes a ocorrer),
  ...
  // Se não estiver carregando e não houver usuário, renderiza a landing page ou a página de vídeo demo.
  if (showVideoDemo) {
  ...
  return (
    <div>
      <HomePage onShowVideoDemo={() => setShowVideoDemo(true)} onShowMessage={handleShowMessage} />
