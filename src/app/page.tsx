...
// Ícones para um visual mais atraente (opcional, mas recomendado)
// Para usar, instale no terminal do seu projeto: npm install lucide-react
import { BarChart, Sparkles, Video } from 'lucide-react';
    ...
    <main className="flex flex-col items-center bg-gray-50 text-gray-800">
      ...
      <section className="w-full text-center py-20 sm:py-32 bg-white shadow-sm">
        <div className="container mx-auto px-4">
          ...
          <Link
            href="/login"
            className="mt-8 inline-block bg-blue-600 text-white font-bold text-lg rounded-lg px-8 py-4 hover:bg-blue-700 transition-colors duration-300 shadow-lg transform hover:scale-105"
          >
      ...
      <section className="w-full text-center py-16 sm:py-24">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl sm:text-4xl font-bold mb-16">Funcionalidades Principais</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="flex flex-col items-center p-6">
              <Sparkles className="w-12 h-12 text-blue-500 mb-4" />
              <h3 className="text-xl font-semibold mb-2">Simulações Interativas</h3>
              <p className="text-gray-600">Ambiente de prova com tempo real e checklists dinâmicos para uma prática eficaz.</p>
            </div>
            <div className="flex flex-col items-center p-6">
      ...
      {/* Seção do Vídeo */}
      <section className="w-full text-center py-16 sm:py-24 bg-white shadow-inner">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl sm:text-4xl font-bold mb-12">Veja a Plataforma em Ação</h2>
          <div className="max-w-4xl mx-auto bg-gray-200 aspect-video rounded-lg flex items-center justify-center shadow-lg">
